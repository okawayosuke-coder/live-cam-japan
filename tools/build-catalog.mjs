...
const REGION_HINTS = [
  ["hokkaido", ["北海道","札幌","函館","旭川","釧路","知床","小樽","帯広","十勝","ニセコ"]],
  ["tohoku", ["東北","青森","秋田","岩手","山形","宮城","仙台","福島","弘前","八戸","郡山","いわき","鶴岡"]],
  ["kanto", ["東京","渋谷","新宿","横浜","千葉","埼玉","茨城","栃木","群馬","神奈川","川越","那須"]],
  ["chubu", ["富士","山梨","長野","新潟","名古屋","愛知","静岡","岐阜","金沢","石川","富山","福井","上高地","能登","柏崎"]],
  ["kinki", ["大阪","京都","神戸","兵庫","奈良","和歌山","滋賀","三重","道頓堀","琵琶湖","鳥羽","志摩"]],
  ["chugoku", ["広島","岡山","山口","鳥取","島根","下関","関門","尾道","倉敷","松江","浜田"]],
  ["shikoku", ["高知","徳島","愛媛","香川","松山","土佐清水","海陽","高松"]],
  ["kyushu", ["福岡","博多","熊本","長崎","鹿児島","宮崎","大分","佐賀","沖縄","那覇","石垣","桜島","阿蘇","名護","八重山","宮古"]],
];
